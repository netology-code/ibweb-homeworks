...
Вы настроите аутентификацию клиентов по X.509 сертификатам на nginx. Вместо nginx может быть использован любой web-сервер, в том числе самописный или встроенный в целевое приложение.
