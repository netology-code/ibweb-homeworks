...
1\. Перейдите по адресу https://gitlab.com/. Для использования всех возможностей необходимо зарегистрироваться и получить 30-дневный доступ. Нажмите Get free trial.
Перейдите по [ссылке](https://gitlab.com/-/trial_registrations/new) и зарегистрируйте новую учётную запись. Попросит подтвердить почтовый ящик, поэтому указываем действую почту.
